...
Questi sono brevi spunti di riflessione nati dal report del MIT sull'uso dell'AI da parte degli studenti e docenti. Lo si può consultare integralmente [qui](https://aiandeducation.mit.edu/report/)
...
Se gli studenti possono scrivere convincenti e buoni report, come testo le conoscenze e le capacità di uno studente se non oralmente?
Mi sembra un bottleneck per grandi esami in triennale
...
Per report, assessments, decisioni importanti, l'analiticità è necessaria, ma non lo è per forza durante l'apprendimento.
Ne riparlo più avanti.
...
Comunque questo punto mi fa pensare ad un'altra cosa, ovvero a come un istruttore deve basate le porprie lezioni.
Mi fa chiedere: come preparo una lezione per lasciar qualcosa allo studente? In particolare nel momento in cui vi è lo strumento della programmazione automatica?
Ovviamente qui prendo un settore specifico ma credo che i discorso possa valere per altri ambiti dove l'uso delle parole è centrale. 
Forse si dovrebbe comunicare più l'intento di un azione, il come impostare un problema, o quali strumenti sono adatti a specifici problemi, o comprensione del perché un design o soluzione è meglio di un altro. Non so, anche qui c'è spazio per tanto.
